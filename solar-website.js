...
const Blockchains = {
    ...
    Ethereum: {
        ...
        custodiedWallets: ["0x6c42c72e80481ad654e63d364bb9d86c90819a25", "0xbe0eb53f46cd790cd13851d5eff43d12404d33e8", "0xf977814e90da44bfa03b6295a0616a897441acec", "0x28c6c06298d514db089934071355e5743bf21d60"],
    ...
    BSC: {
        ...
        custodiedWallets: ["0xe2fc31f816a9b94326492132018c3aecc4a93ae1", "0x8894e0a0c962cb723c1976a4421c95949be2d4e3", "0xf977814e90da44bfa03b6295a0616a897441acec", "0x5a52e96bacdabb82fd05763e25335261b270efcb", "0x0000000000000000000000000000000000001004"],
    ...
    socket.on('getBlockchainStats', function(input) {
        (async() => {
            ...
            if (rq_wallets.meta) {
                ...
                response.swapped = 520737576 - (rq_wallets.data[0].balance / 100000000)
            }
